...
logger_get_all_info = logging.getLogger(f"logger_method")
get_all_info_handler = logging.FileHandler(f"logger_get_all_info.log")
...
logger_get_dns_info = logging.getLogger(f"logger_method")
get_dns_info_handler = logging.FileHandler(f"logger_get_dns_info.log")
...
logger_get_http_info = logging.getLogger(f"logger_method")
get_http_info_handler = logging.FileHandler(f"logger_get_http_info.log")
...
logger_get_whois_info = logging.getLogger(f"logger_method")
get_whois_info_handler = logging.FileHandler(f"logger_get_whois_info.log")
...
logger_get_whois_text = logging.getLogger(f"logger_method")
get_whois_text_handler = logging.FileHandler(f"logger_get_whois_text.log")
